package msu.grad.csit697.banking_app.unit;
...
class TransactionServiceTest {
    ...
    @BeforeEach
    void setUp() {
        var sourceAccount = new msu.grad.csit697.banking_app.models.Account(1L, "53-68-92", "78901234", 458.1, "Some Bank", "John");
        var targetAccount = new msu.grad.csit697.banking_app.models.Account(2L, "67-41-18", "48573590", 64.9, "Some Other Bank", "Major");
